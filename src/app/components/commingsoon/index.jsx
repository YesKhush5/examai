    ...
    <section className="container border border-gray-200 py-12 rounded-xl mx-auto">
      <div className="flex flex-col w-full ">
        ...
        <div className="flex flex-col mt-8 space-y-3 sm:-mx-2 sm:flex-row sm:justify-center sm:space-y-0">
          ...
          <button className="px-8 py-3 text-sm font-medium tracking-wide text-black capitalize transition-colors duration-300 transform bg-blue-500 rounded-md hover:bg-blue-600 focus:bg-blue-600 focus:outline-none sm:mx-2">
            Notify Me
          </button>
        </div>

        <p className="mt-8 text-center text-gray-700 dark:text-black text-md md:text-xl">
